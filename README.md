...
The v5 design spec lives in the companion the-upstream-workspace workspace at `docs/superpowers/specs/2026-05-06-ghost-in-shell-v5-design.md`. A condensed public spec will be published here once v5.0.0a1 is tagged.
